 ...
 * Time: 11:34.
 */
public class BounceHud extends View {
    ...
    public BounceHud(Context context) {
        this(context, null);
    }

    public BounceHud(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public BounceHud(Context context, AttributeSet attrs, int defStyleAttr) {
